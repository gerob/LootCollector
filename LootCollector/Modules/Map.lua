...
function Map:Update(forceSync)
    if not WorldMapFrame or not WorldMapFrame:IsShown() then return end
    
    local currentMapID = GetCurrentMapAreaID()
    if forceSync or (currentMapID ~= self.lastMapID) then
        self.lastMapID = currentMapID
        self.worldMapUpdatePending = false
